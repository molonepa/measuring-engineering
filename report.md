...
This isn't a silver bullet however, as equally CNNs, owing to their opacity (since humans aren't responsible for codifying the rules), can reinforce and amplify human bias. In my opinion, a balance of human and machine intelligence would be the best interpreter for the data to produce the best results.
